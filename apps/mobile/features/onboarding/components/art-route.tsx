    ...
    <View className="flex-1 bg-[#eae2c8]">
      <Svg width="100%" height="100%" viewBox="0 0 320 340" preserveAspectRatio="xMidYMid slice">
        {[
          ...
          <Rect key={i} x={x} y={y} width={w} height={h} fill="#d9cfae" stroke="#c4b894" strokeWidth="0.8" rx="1" />
        ))}
        ...
        <Path
          ...
          strokeLinecap="round"
        />
        <Circle cx="60" cy="280" r="9" fill="#fff" stroke="#2e5d45" strokeWidth="3" />
        <Circle cx="60" cy="280" r="3" fill="#2e5d45" />
      </Svg>
      <View
        className="absolute"
        style={{ left: "74%", top: "18%", transform: [{ translateX: -28 }, { translateY: -56 }] }}
      >
        <MosqueMark size="md" />
      </View>
    </View>
